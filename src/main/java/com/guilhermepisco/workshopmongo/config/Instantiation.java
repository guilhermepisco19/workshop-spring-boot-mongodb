...
import com.guilhermepisco.workshopmongo.dto.AuthorDTO;
import com.guilhermepisco.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018"), "Lets Travel", "I will travel to São Paulo. Regards!", new AuthorDTO(maria));
		Post post2 = new Post(null, sdf.parse("23/03/2018"), "Good morning", "I woke up happy today!", new AuthorDTO(maria));
		
		CommentDTO c1 = new CommentDTO("Have a nice journey!", sdf.parse("21/03/2018"), new AuthorDTO(alex));
